...
public class HospitalizacionProxyController {
    private static final String BACKEND_PATH = "/api/v1/hospitalizaciones";

    private final BackendProxyService backendProxyService;

    public HospitalizacionProxyController(BackendProxyService backendProxyService) {
